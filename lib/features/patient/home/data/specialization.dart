...
List<SpecializationCardModel> cards = [SpecializationCardModel(specializations[0], skyBlue, lightBlue), SpecializationCardModel(specializations[1], green, lightGreen), SpecializationCardModel(specializations[2], orange, lightOrange), SpecializationCardModel(specializations[3], purple, purpleLight), SpecializationCardModel(specializations[4], green, lightGreen), SpecializationCardModel(specializations[5], skyBlue, lightBlue), SpecializationCardModel(specializations[6], green, lightGreen)];
